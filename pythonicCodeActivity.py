    ...
    new Vue({
        ...
        data: function () {
            ...
            questions:[
                ...
                {header:"Editable Code Block", subHeader:'Your code goes below', vModel:"def ifFunc(a,b):\\n if a == True:  \\n  return b\\n"},
                ...
                {header:"Editable Code Block", subHeader:'Your code goes below', vModel:"def forLoop(listOfNumbers):\\n total = 0 \\n index = 0 \\n while index < len(listOfNumbers):\\n  total += listOfNumbers[index]\\n  index += 1\\n return total"},
                ...
                {header:"Editable Code Block", subHeader:'Your code goes below', vModel:"def useEnumerate(list):\\n locationOfItems = '' \\n for index in range(len(list)): \\n  value = list[index]\\n  locationOfItems += f'{value} is at index {index} '\\n return locationOfItems"},
                ...
                {header:"Editable Code Block", subHeader:'Your code goes below', vModel:"def useZip(list1, list2):\\n resultString = ''\\n for index, value in enumerate(list1):\\n  resultString += f'{value} is {list2[index]} '\\n return resultString"},
